...
import styles from 'app/(game)/(village-slug)/(village)/components/building-field.module.scss';
        ...
        <>
          ...
          >
            <g className="hoverShape transition-colors duration-150">
              <path 
                d={HOVER_PATHS[getGidFromBuildingId(buildingId)] || HOVER_PATHS['0']}
      ...
      {isVillageBuilding && isWallBuilding(buildingId) && (
        <>
          <img
            ...
            style={{ zIndex: 42, width: '100%', height: '100%', filter: isHovered ? 'brightness(1.2)' : 'none' }}
          />
          <img
            ...
            style={{ zIndex: 0, width: '100%', height: '100%', filter: isHovered ? 'brightness(1.2)' : 'none' }}
          />
          <svg 
            width="100%" 
            height="100%" 
          ...
          >
            <g className="hoverShape transition-colors duration-150 fill-transparent pointer-events-auto">
              <path 
                d={HOVER_PATHS['32_bottom']}
              />
              <path 
                d={HOVER_PATHS['32_top']}
              />
            </g>
          </svg>
        </>
